...
<body>
    ...
    <form action="{{URL::to('/cadastrarlivro')}}" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="1" method="POST" name="nome" >
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Resumo</label>
            <input type="text" class="form-control" id="2" method="POST" name="resumo">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Autor</label>
            <input type="text" class="form-control" id="3" method="POST" name="autor">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Editora</label>
            <input type="text" class="form-control" id="4" method="POST" name="editora">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">N° Exemplares</label>
            <input type="integer" class="form-control" id="5" method="POST" name="exemplares">
        </div>
