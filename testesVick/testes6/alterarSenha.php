    ...
    <div class="bloco-login">
        ...
        <div class="ItensLogin">
            ...
            <form method="post" action="">
                <label for="nova_senha" id="newpass">Nova Senha:</label>
                <input type="password" id="nova_senha" name="nova_senha" required><br><br>
                <label for="confirma_nova_senha" id="confirm">Confirmação:</label>
                <input type="password" id="confirma_nova_senha" name="confirma_nova_senha" required><br><br>
                <input type="submit" value="Redefinir Senha"><br><br>
